...
import com.mcz.greenhouse_chinese.app.model.DataInfo;
import com.mcz.greenhouse_chinese.app.model.PullrefreshListviewAdapter;
import com.mcz.greenhouse_chinese.app.ui.activity.InputManualActivity;
import com.mcz.greenhouse_chinese.app.ui.zxing.zxing.new_CaptureActivity;
import com.mcz.greenhouse_chinese.app.utils.Config;
import com.mcz.greenhouse_chinese.app.utils.DataManager;
import com.mcz.greenhouse_chinese.app.view.view.IPullToRefresh;
import com.mcz.greenhouse_chinese.app.view.view.LoadingLayout;
import com.mcz.greenhouse_chinese.app.view.view.PullToRefreshBase;
import com.mcz.greenhouse_chinese.app.view.view.PullToRefreshFooter;
import com.mcz.greenhouse_chinese.app.view.view.PullToRefreshHeader;
import com.mcz.greenhouse_chinese.app.view.view.PullToRefreshListView;
...
//                if(object.optString("deviceType").equals("Wifi"))//读完设备类型确认
//                {
                    if (object.optString("status").equals("ONLINE")){
                        ...
                        for (int j = 0; j < jsa.length(); j++) {
                            ...
                            dataInfo.setDevicetemperature(jsonObject.optString("Temp"));//和profile文件一樣
                            dataInfo.setDevicehumidity(jsonObject.optString("Hum"));
...
//                {
//
//                    ///////这里写入非这个"WIFI" 的profile文件设备的处理代码
//                }
