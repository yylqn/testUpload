package com.mcz.greenhouse_chinese.app.utils;
...
import static com.mcz.greenhouse_chinese.app.utils.Config.SELFCERTPATH;
import static com.mcz.greenhouse_chinese.app.utils.Config.SELFCERTPWD;
import static com.mcz.greenhouse_chinese.app.utils.Config.TRUSTCAPATH;
import static com.mcz.greenhouse_chinese.app.utils.Config.TRUSTCAPWD;
...
//        params.add(new BasicNameValuePair("accessToken", accessToken));
    ...
    //命令下发
    public static String Comened_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String deviceId,String Switch,String method,String Switchname)
            throws Exception{
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("deviceId", deviceId));
        params.add(new BasicNameValuePair("serviceId", "GreenHouse"));
        params.add(new BasicNameValuePair("method", method));
        params.add(new BasicNameValuePair(Switchname, Switch));
    ...
    public static String UPDATE_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String name)
        ...
        params.add(new BasicNameValuePair("deviceType", "Wifi"));
        params.add(new BasicNameValuePair("model", "AgentTiny"));
        params.add(new BasicNameValuePair("manufacturerId", "SA"));
        params.add(new BasicNameValuePair("manufacturerName", "SA"));
        params.add(new BasicNameValuePair("protocolType", "LWM2M"));
